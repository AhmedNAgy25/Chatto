...
const PREVIEW_MESSAGES = [
  { id: 1, content: "Hey! did you feed the cat ? ", isSent: false },
  {
    id: 2,
    content: "Everything's fine! Just fed the cats their meal now",
    isSent: true,
  },
];
...
const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-base-100 container mx-auto px-3 sm:px-4 pt-16 sm:pt-20 max-w-5xl">
      <div className="space-y-4 sm:space-y-6">
        ...
        <h3 className="text-lg sm:text-xl font-semibold mb-3">Preview</h3>
                ...
                <div className="p-3 sm:p-4 space-y-3 sm:space-y-4 min-h-[150px] sm:min-h-[200px] max-h-[150px] sm:max-h-[200px] overflow-y-auto bg-base-100">
                  {PREVIEW_MESSAGES.map((message) => (
                    ...
                    >
                      <div
                        className={`
                          max-w-[85%] sm:max-w-[80%] rounded-xl p-2 sm:p-3 shadow-sm
                          ${
                            message.isSent
